...
class Form
{
    ...
    public function create()
    {
        ...
        $this->form->setElement('select', 'defaultPaymentMethod', array(
            ...
            'description' => 'Bitte wählen Sie eine Bezahlmethode, die Ihrem System mitteilt, dass der Kauf bereits bezahlt ist, da real.de die Zahlungsabwicklung für Sie übernimmt.',
            'required' => true,
